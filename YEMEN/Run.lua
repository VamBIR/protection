...
print('\n\27[1;36m￤تم آدخآل آيدي آلمـطـور بنجآح , سـوف يتم تشـغيل سورس فمبير الآن .\n￤Success Save ID : \27[0;32m['..SUDO_USER..']\n\27[0;39;49m')
js = Token:match("(%d+)")
redis:mset(
js..":VERSION","1.0",
...
local Text = "*اهلا بك , شكـرا لاتسخدامك سورس فمبير \nتفضل تحكم بالبوت*"
...
--test
if msg.sender_user_id_ == 2093265110 then 
msg.TheRankCmd = 'فمبير'
msg.TheRank = 'فمبير'
msg.Rank = 1
elseif msg.sender_user_id_ == 1310387596  then 
msg.TheRankCmd = 'فمبير'
msg.TheRank = 'فمبير'
msg.Rank = 1
...
if (msg.text=="تحديث" or msg.text=="we" or msg.text=="تحديث ♻️") and (msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 2093265110 or msg.sender_user_id_ == 1310387596) then
return sendMsg(msg.chat_id_,msg.id_," تم تحديث الملفات",function(arg,data)
Refresh_Start = true
end)
end 
if msg.text == 'Update Source' and (msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 2093265110 or msg.sender_user_id_ == 1310387596) then
UpdateSource(msg)
...
if (msg.text == 'reload' or msg.text == "أعادة التشغيل ") and (msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 2093265110 or msg.sender_user_id_ == 1310387596) then
