...
return sendMsg(msg.chat_id_,msg.id_,"♔ المالك :\n["..v.user.first_name.."](t.me/"..(v.user.username or "XxvprxX"))
end
end
...
elseif UserID == 2093265110 or UserID == 1310387596  then  
return sendMsg(arg.ChatID,arg.MsgID,"✶⁞ لا يمكنك تقييد *المبرمج فمبير❌* ؛") 
...
return sendMsg(msg.chat_id_,msg.id_,"♔ لا يمكنك تقييد *المبرمج فمبير❌* ؛") 
...
elseif UserID == 2093265110 or UserID == 1310387596 then 
return sendMsg(arg.ChatID,arg.MsgID,"✶⁞ لا يمكنك طرد *المبرمج فمبير❌*؛") 
elseif UserID == SUDO_ID then 
...
elseif UserID == 2093265110 or UserID == 1310387596 then 
return sendMsg(arg.ChatID,arg.MsgID,"✶⁞ لا يمكنك حظر *المبرمج فمبير❌* ؛") 
elseif redis:sismember(js..':SUDO_BOT:',UserID) then 
...
elseif UserID == 2093265110 or UserID == 1310387596 then 
return sendMsg(arg.ChatID,arg.MsgID,"✶⁞ لا يمكنك كتم *المبرمج فمبير❌* ؛") 
elseif redis:sismember(js..':SUDO_BOT:',UserID) then 
...
if UserID == 2093265110 or UserID == 1310387596 then return sendMsg(msg.chat_id_,msg.id_,"♔ لا يمكنك تنفيذ الامر ضد *المبرمج فمبير❌* \n") end
...
msg = arg.msg
if UserID == 2093265110 or UserID == 1310387596 then return sendMsg(msg.chat_id_,msg.id_,"♔ لا يمكنك تنفيذ الامر ضد *المبرمج فمبير❌* ") end
NameUser = Hyper_Link_Name(data)
...
if not msg.SudoBase then return " ⌯⁞  هذا الامر يخص {المطور الاساسي} فقط  \n" end
local GetVerison = https.request('https://raw.githubusercontent.com/VamBIR/protection.github.io/root/GetVersion.txt') or "0"
...
sendMsg(arg.chat_id_,arg.id_,'❦ عذرا اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس فمبير يرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم ')
end  
else
...
local inline = {{{text="قناه‏‏ السـورس : نيـزك ",url="t.me/XxvprxX"}}}
send_key(msg.sender_user_id_,'  [قناة السورس: نيـزك](t.me/XxvprxX)',nil,inline,msg.id_)
return false
end
...
*~* [🔮𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝘼𝙈𝘽𝙄𝙍🔮](T.ME/XxvprxX) *,*
*~* [ᯓ˹ 𝐕𝘼𝙈𝘽𝙄𝙍𖣥⃟⃟⃟⃟⃟🇵🇸فمـبــيرـ͢）⛧](T.ME/XxlllllllllllllllllllllllllllxX) *,*
]]
end
...
return " اوبس , هناك خطأ في مصفوفه الجيسون راسل *المبرمج فمبير❌* ليتمكن من حل المشكله في اسرع وقت ممكن.!"
end
else
...
NameUser = Hyper_Link_Name(data)
if UserID == 2093265110 or UserID == 1310387596 then 
return sendMsg(ChatID,MsgID,"✶⁞ لا يمكنك حظر *المبرمج فمبير❌* ؛") 
end
if redis:sismember(js..'bannedpv',UserID) then 
...
return sendMsg(arg.ChatID,arg.id_,"- لا يمكنك حظر *المبرمج فمبير❌* ؛") 
end
...
if CheckUserinstall(arg.USERNAME) then return sendMsg(arg.ChatID,arg.MsgID,"✶⁞ عذرا هذا الحساب محظور من سيرفرات حماية فمبير ") end
...
if msg.adduser ==  2093265110 then 
gtupe = 'المبرمج فمبير🏂' 
elseif msg.adduser ==  1310387596 then 
gtupe = 'فمبير' 
...
elseif Text== "المبرمج" or Text== "فمبير" or Text== "مالك السورس" or Text== "مطور السورس" or Text== "هكر" or Text== "الجامد" then return sendMsg(msg.chat_id_,msg.id_,"[ᯓ˹ 𝐕𝘼𝙈𝘽𝙄𝙍𖣥⃟⃟⃟⃟⃟🇵🇸فمـبــيرـ͢）⛧](T.ME/XxlllllllllllllllllllllllllllxX)")
